...
#
# Description:
# R1337 Tool  is a password cracking tool written in perl to perform a dictionary-based attack on a specific Facebook user through HTTPS.
#
# Usage:
# perl R1337 login wordlist
...
#
# --- R1337 Facebook password cracking tool created by paul1ca
# --- By paul1ca
# --- https://www.youtube.com/channel/UCWPsIUWdFcDC5g2tIEfscQw
#
...
system('clear');
print "\n+++ R1337 Facebook password Bruteforcer\n";
print "+++ Created by paul1ca\n";
print "+++ https://www.youtube.com/channel/UCWPsIUWdFcDC5g2tIEfscQw\n\n";
...
{
print "\n########################################################\n";
print "[+] Gata! Am spart => Parola este $password :D like+sub\n";
print "########################################################\n\n";
close SSL;
exit;
}
